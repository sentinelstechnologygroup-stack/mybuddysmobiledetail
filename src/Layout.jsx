...
export default function Layout(props) {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
                ...
                return (
                  <Link
                    ...
                    style={{
                      ...
                      backgroundColor: isActive ? "rgba(37, 99, 235, 0.92)" : "transparent",
                      borderColor: isActive ? "rgba(96, 165, 250, 0.42)" : "transparent",
                      boxShadow: isActive ? "0 8px 20px rgba(37, 99, 235, 0.24)" : "none",
                    }}
                  >
                    {link.label}
                  </Link>
          ...
          {mobileOpen && (
            ...
            >
              <div className="px-6 py-6 space-y-1">
                ...
                <a
                  href={site.phoneHref}
                  className="w-full mt-4 px-4 py-3 rounded-xl text-center font-semibold flex items-center justify-center gap-2 text-white"
                  style={{
                    background:
      ...
      <footer
        className="border-t"
        style={{ backgroundColor: "#07080c", borderColor: "var(--color-border)" }}
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              >
                ...
                Over 20 years of experience in automotive care.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-start gap-3 text-sm mb-8">
                <Clock className="w-4 h-4 mt-0.5" style={{ color: "rgba(37, 99, 235, 0.6)" }} />
                <div>
                  <p className="font-medium" style={{ color: "var(--color-text-primary)" }}>
                    7 Days a Week
                  </p>
                  <p style={{ color: "var(--color-text-secondary)" }}>7:00 AM – 6:00 PM</p>
                </div>
              </div>
            </div>
          </div>
